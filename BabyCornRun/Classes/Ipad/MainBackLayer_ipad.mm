...
-(id) init
{
    ...
    if( (self=[super init] )) {
       ...
       //world->SetDebugDraw(m_debugDraw);
        ...
        if (isFirstMain){
            isFirstMain = false;
            groundTex = [[CCTextureCache sharedTextureCache] textureForKey:@"ground_004-hd.png"];
        }
        else {
            groundTex = [[CCTextureCache sharedTextureCache] addImage:@"ground_004-hd.png"];
        }
