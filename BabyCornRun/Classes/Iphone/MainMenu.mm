...
-(id) init
{
    ...
    if( (self=[super init] )) {
        ...
        CCSprite *logo = [CCSprite spriteWithTexture:[[CCTextureCache sharedTextureCache] addImage:@"logo1.png"]];
        ...
        CCMenuItem *play = [CCMenuItemSprite itemFromNormalSprite:[CCSprite spriteWithTexture:[[CCTextureCache sharedTextureCache] addImage:@"play.png"]]
                                                   selectedSprite:[CCSprite spriteWithTexture:[[CCTextureCache sharedTextureCache] addImage:@"play.png"]]
                                                           target:self
                                                         selector:@selector(startGame:)];
        play.position = ccp(190, 40);
        
        CCMenuItem *moreGames = [CCMenuItemSprite itemFromNormalSprite:[CCSprite spriteWithTexture:[[CCTextureCache sharedTextureCache] addImage:@"more.png"]]
                                                   selectedSprite:[CCSprite spriteWithTexture:[[CCTextureCache sharedTextureCache] addImage:@"more.png"]]
                                                           target:self
                                                         selector:@selector(openMoreApps:)];
        moreGames.position = ccp(190, -20);
        
        CCMenuItem *news = [CCMenuItemSprite itemFromNormalSprite:[CCSprite spriteWithTexture:[[CCTextureCache sharedTextureCache] addImage:@"news.png"]]
                                                        selectedSprite:[CCSprite spriteWithTexture:[[CCTextureCache sharedTextureCache] addImage:@"news.png"]]
                                                                target:self
                                                              selector:@selector(openNews:)];
        news.position = ccp(110, 25);
        
        CCMenuItem *shop = [CCMenuItemSprite itemFromNormalSprite:[CCSprite spriteWithTexture:[[CCTextureCache sharedTextureCache] addImage:@"shop1.png"]]
                                                   selectedSprite:[CCSprite spriteWithTexture:[[CCTextureCache sharedTextureCache] addImage:@"shop1.png"]]
                                                           target:self
                                                         selector:@selector(openShop:)];
        shop.position = ccp(110, -25);
        
        CCMenuItem *achievements = [CCMenuItemSprite itemFromNormalSprite:[CCSprite spriteWithTexture:[[CCTextureCache sharedTextureCache] addImage:@"achievements.png"]]
                                                   selectedSprite:[CCSprite spriteWithTexture:[[CCTextureCache sharedTextureCache] addImage:@"achievements.png"]]
                                                           target:self
                                                         selector:@selector(openAchievements:)];
        achievements.position = ccp(50, -80);
        ...
        gamecenter.position = ccp(100, -80);
        ...
        backSoundoff.position = ccp (360.5, screenSize.height-215);
        if (backSoundOn)
        ...
        effectSoundoff.position = ccp (415.5, screenSize.height-215);
        if (effectsoundOn)
...
- (void) openNews: (id) sender
{
    ...
    NewsviewController   *movetoview=[[NewsviewController alloc]initWithNibName:@"NewsviewController" bundle:nil];
    [[[CCDirector sharedDirector]openGLView]addSubview:movetoview.view];
}
...
-(void)ProcessComplete
{
    ...
    if ([nagArray count]>0)
    {
        NagView = [[UIView alloc] initWithFrame:CGRectMake(0,0,480,320)];
        ...
        {
            frame.size.width=400; frame.size.height=280;
        ...
        cancel.frame= CGRectMake(420, 5, 40, 40);
