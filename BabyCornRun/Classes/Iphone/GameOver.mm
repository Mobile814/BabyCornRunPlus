...
-(id) init
{
	...
	if( (self=[super init])) {
        ...
        CCSprite *background = [CCSprite spriteWithTexture:[[CCTextureCache sharedTextureCache] addImage:[NSString stringWithFormat: @"background.png"]]];
        ...
        CCSprite *bestScoreLbl = [CCSprite spriteWithTexture:[[CCTextureCache sharedTextureCache] addImage:[NSString stringWithFormat: @"bestscore.png"]]];
        bestScoreLbl.anchorPoint = ccp(0.0, 1.0);
        bestScoreLbl.position = ccp (10, screenSize.height-10);
        [self addChild:bestScoreLbl z:0];
        
        CCSprite *score = [CCSprite spriteWithTexture:[[CCTextureCache sharedTextureCache] addImage:[NSString stringWithFormat: @"score.png"]]];
        score.anchorPoint = ccp(0.0, 1.0);
        score.position = ccp (170, screenSize.height-71);
        [self addChild:score z:0];
                
        scoreLabel = [CCLabelTTF labelWithString:[NSString stringWithFormat:@"%d", runMeters] dimensions:CGSizeMake(100, 50) alignment:UITextAlignmentLeft fontName:@"Marker Felt" fontSize:28];
        scoreLabel.color = ccBLACK;
        scoreLabel.position = ccp( 282, screenSize.height-98);
    
        [self addChild:scoreLabel];
        
        if (runMeters > bestScore) {
            bestScore = runMeters;
            CCSprite *highscore = [CCSprite spriteWithTexture:[[CCTextureCache sharedTextureCache] addImage:[NSString stringWithFormat: @"hiscore.png"]]];
            highscore.anchorPoint = ccp(0.0, 1.0);
            highscore.position = ccp (316, screenSize.height-60);
        ...
        CCMenuItem *playAgain = [CCMenuItemSprite itemFromNormalSprite:[CCSprite spriteWithTexture:[[CCTextureCache sharedTextureCache] addImage:@"playagain.png"]]
                                                   selectedSprite:[CCSprite spriteWithTexture:[[CCTextureCache sharedTextureCache] addImage:@"playagain.png"]]
                                                           target:self
                                                         selector:@selector(startGame:)];
        
        playAgain.position = ccp(0, -80);
        
        CCMenuItem *mainmenu = [CCMenuItemSprite itemFromNormalSprite:[CCSprite spriteWithTexture:[[CCTextureCache sharedTextureCache] addImage:@"mainmenu1.png"]]
                                                       selectedSprite:[CCSprite spriteWithTexture:[[CCTextureCache sharedTextureCache] addImage:@"mainmenu1.png"]]
                                                               target:self
                                                             selector:@selector(goToMenu:)];
        mainmenu.position = ccp(-55, -30);
        
        CCMenuItem *shop = [CCMenuItemSprite itemFromNormalSprite:[CCSprite spriteWithTexture:[[CCTextureCache sharedTextureCache] addImage:@"shop2.png"]]
                                                       selectedSprite:[CCSprite spriteWithTexture:[[CCTextureCache sharedTextureCache] addImage:@"shop2.png"]]
                                                               target:self
                                                             selector:@selector(openShop:)];
        shop.position = ccp(55, -30);
        
        CCMenuItem *facebook = [CCMenuItemSprite itemFromNormalSprite:[CCSprite spriteWithTexture:[[CCTextureCache sharedTextureCache] addImage:@"fbicon.png"]]
                                                   selectedSprite:[CCSprite spriteWithTexture:[[CCTextureCache sharedTextureCache] addImage:@"fbicon.png"]]
                                                           target:self
                                                         selector:@selector(goToFacebook:)];
        facebook.position = ccp(-50, 20);
        
        CCMenuItem *twitter = [CCMenuItemSprite itemFromNormalSprite:[CCSprite spriteWithTexture:[[CCTextureCache sharedTextureCache] addImage:@"ticon.png"]]
                                                   selectedSprite:[CCSprite spriteWithTexture:[[CCTextureCache sharedTextureCache] addImage:@"ticon.png"]]
                                                           target:self
                                                         selector:@selector(goToTwitter:)];
        twitter.position = ccp(0, 20);
        
        CCMenuItem *gamecenter = [CCMenuItemSprite itemFromNormalSprite:[CCSprite spriteWithTexture:[[CCTextureCache sharedTextureCache] addImage:@"gicon.png"]]
                                                   selectedSprite:[CCSprite spriteWithTexture:[[CCTextureCache sharedTextureCache] addImage:@"gicon.png"]]
                                                           target:self
                                                         selector:@selector(openGameCenter:)];
        gamecenter.position = ccp(50, 20);
